...
const exportPDF = (caseItem) => {
    ...
    doc.text("Tel: +603-6419 5989 | Fax: +603-6419 5987 | Email: wl_kl@wongloh.com", 14, 25); // Contact info
    ...
    doc.setLineWidth(0.5);
    doc.line(14, doc.internal.pageSize.height - 30, 195, doc.internal.pageSize.height - 30); // Footer line
